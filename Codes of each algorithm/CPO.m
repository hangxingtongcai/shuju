...
N_min=round(0.6*Pop_size); %% Is the minimum population size.
T=1; %% The number of cycles
alpha=0.5; %% The convergence rate
Tf=0.3; %% The percentage of the tradeoff between the third and fourth defense mechanisms
